...
<div>
    <table style="width: 100%; margin-top: 30px;">
        <tr>
            <td style="font-size: 12.5px;">ชื่อ / Name:
            </td>
            <td style="font-size: 12.5px;">ตำแหน่ง / Position:
            </td>
        </tr>
        <tr>
            <td style="font-size: 12.5px;">ระดับ / Level:
            </td>
            <td style="font-size: 12.5px;">หน่วยงาน / Dept.:
            </td>
        </tr>
    </table>
</div>
...
<div>
    <table class="tablethin" style="width: 100%; text-align: center;" border="1" cellpadding="0" cellspacing="0">
        <tr>
            <td style="text-align: center; font-size: 12.5px; width:15%;">วันเดือนปี</td>
            <td style="text-align: center; font-size: 12.5px; width:30%;">รายการ</td>
            <td style="text-align: center; font-size: 12.5px; width:15%;">ลิตร</td>
            <td style="text-align: center; font-size: 12.5px; width:15%;">จำนวนเงิน</td>
            <td style="text-align: center; font-size: 12.5px; width:25%;">หมายเหตุ</td>
        </tr>
        <tr>
            <td>1</td>
            <td></td>
        ...
        <tr>
            <td colspan="2" class="textRight font12">รวมค่าใช้จ่ายในการเดินทาง/ต่าใช้จ่ายประจำเดือน (ไม่รวมค่าเลี้ยงรับรองหรือการตรวจตลาด)
...
<div>
    <table class="tablethin" style="width: 100%; text-align: center;" border="1" cellpadding="0" cellspacing="0">
        <tr>
            <td class="fontDocV2" style="text-align: center; font-size: 12.5px; width:15%;">วันที่</td>
            <td class="fontDocV2" style="text-align: center; font-size: 12.5px; width:20%;">สถานที่</td>
            <td style="text-align: center; font-size: 12.5px; width:35%;">จุดประสงค์</td>
            <td style="text-align: center; font-size: 12.5px; width:20%;">ชื่อลูกค้า</td>
            <td style="text-align: center; font-size: 12.5px; width:15%;">รวมเป็นจำนวนเงิน</td>
        </tr>
        <tr>
            <td>1</td>
            <td></td>
        ...
        <tr>
            <td colspan="4" class="textRight font12">
