...
namespace eActForm.BusinessLayer
{
	...
	{
		public static List<TB_Bud_Image_Model.BudImageModel> getImageBudget(string budgetApproveId, String activityNo, String createdByUserId)
		{
			try
			{
		...
		public static int insertImageBudget(TB_Bud_Image_Model.BudImageModel model)
		{
			...
			try
			{
				result = SqlHelper.ExecuteNonQuery(AppCode.StrCon, CommandType.StoredProcedure, "usp_insertImageBudget"
		...
		public static int deleteImageBudgetById(string fileId)
		{

			int result = 0;
			try
			{
				result = SqlHelper.ExecuteNonQuery(AppCode.StrCon, CommandType.StoredProcedure, "usp_deleteImageBudgetbyId"
