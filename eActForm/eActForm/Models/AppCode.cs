...
namespace eActForm.Models
{
    public class AppCode
    {
        ...
        public static string[] hcForm = { ConfigurationManager.AppSettings["formExpTrvNumId"], ConfigurationManager.AppSettings["formExpMedNumId"], ConfigurationManager.AppSettings["formTrvHome"] };
        ...
        public static string[] compHcForm = { Activity_Model.groupCompany.NUM.ToString(), Activity_Model.groupCompany.POM.ToString(), Activity_Model.groupCompany.CVM.ToString(), Activity_Model.groupCompany.TTM.ToString() };
        ...
        public static string[] checkDocHC =
        {
           ...
           ConfigurationManager.AppSettings["formExpTrvNumId"],
           ConfigurationManager.AppSettings["formExpMedNumId"],
           ConfigurationManager.AppSettings["formTrvHome"]
        ...
        public static string[] checkDocAll =
       {
        ...
        {
            public const string MedIndividual = "CCD77323-B7CE-4A22-ACC2-99BB1C972E3F";
