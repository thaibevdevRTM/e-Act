...
namespace eActForm.Controllers
{
    ...
    {
        // GET: parialPriceStructureList

        public ActionResult productSetPriceList(string actId)
        {
      ...
      , string dateActivitySt)
        ...
        public bool calProductDetail(ProductCostOfGroupByPrice model)
        {
            ...
            try
            {
                ...
                activityModel = (Activity_TBMMKT_Model)TempData["actForm" + model.activityId];
        ...
        public JsonResult delCostDetail(string rowid, string id)
        {
            ...
            try
            {
                Activity_TBMMKT_Model activityModel = TempData["actForm" + id] == null ? new Activity_TBMMKT_Model() : (Activity_TBMMKT_Model)TempData["actForm" + id];
                if (rowid != null)
                {
        ...
        {
            Activity_TBMMKT_Model activityModel = TempData["actForm" + actId] == null ? new Activity_TBMMKT_Model() : (Activity_TBMMKT_Model)TempData["actForm" + actId];
            Activity_TBMMKT_Model ShowList_Product = new Activity_TBMMKT_Model();
