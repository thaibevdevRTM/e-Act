    ...
    public class ActivityCostDetailController : Controller
    {
        ...
        public JsonResult addCostDetailTheme(string themeId, string txttheme,string actId ,string brandId)
        {
            ...
            try
            {
               ...
               // costThemeDetailOfGroupByPriceModel.IO = "56S0" + DateTime.Now.Year.ToString().Substring(2) + ActFormAppCode.getDigitGroup(themeId) + ActFormAppCode.getDigitRunnigGroup(brandId);
