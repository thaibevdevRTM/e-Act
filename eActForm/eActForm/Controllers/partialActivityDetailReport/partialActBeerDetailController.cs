...
namespace eActForm.Controllers
{
    public partial class partialActivityDetailReportController
    {
        ...
        public ActionResult partialActBeerDetailRpt(Activity_TBMMKT_Model activity_TBMMKT_Model)
        {
            ...
            activity_TBMMKT_Model.activityFormTBMMKT.chanel = QueryGetAllChanel.getAllChanel().Where(x => x.no_tbmmkt.Equals(ConfigurationManager.AppSettings["conditionGetMaster"])).Where(x => x.id.Equals(activity_TBMMKT_Model.tB_Act_ActivityForm_DetailOther.channelId)).FirstOrDefault().chanelGroup;
