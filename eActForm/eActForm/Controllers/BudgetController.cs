	...
	public class BudgetController : Controller
	{
		...
		public ActionResult activityList(string typeForm)
		{
			...
			try
			{
				...
				{
					models.Budget_Activity_list = QueryGetBudgetActivity.getBudgetActivity("3", null, null, null, typeForm, DateTime.Now.AddDays(-180).ToString("MM/dd/yyyy"), DateTime.Now.ToString("MM/dd/yyyy"), null).ToList();
				}
		...
		//searchBudgetActivity
		//public ActionResult searchBudgetActivity()
		//{
		//	Budget_Activity_Model model = new Budget_Activity_Model();
		//	try
		//	{
		//		string act_createdDateStart = null;
		//		string act_createdDateEnd = null;
		...
		//		//model = QueryGetBudgetReport.getReportBudgetActivity(null, null, act_formType, act_createdDateStart, act_createdDateEnd);

		//		model.Budget_Activity_list = QueryGetBudgetActivity.getBudgetActivity("3", null, null, null, act_formType).ToList();
		//	}
		//	catch (Exception ex)
		//	{
